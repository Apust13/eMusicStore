...
import com.apust.emusicstore.model.BillingAddress;
import com.apust.emusicstore.model.Customer;
import com.apust.emusicstore.model.ShippingAddress;
...
public class RegisterController {
    ...
    public String registerCustomerPost(@Valid @ModelAttribute("customer") Customer customer,BindingResult result , Model model){
        ...
        for(int i=0; i<customerList.size(); i++){
            ...
            if(customer.getCustomerName().equals(customerList.get(i).getCustomerName())){
